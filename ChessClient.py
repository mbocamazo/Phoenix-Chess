...
class ChessClient:
    ...
    def mainLooptemp(self):     
        ...
        player_2 = ChessAI(ChessBoard.BLACK,chess,evaluation_functions.simple_piece_eval,prune_functions.never_prune,2)
...
class ChessBoard:
    ...
    _board = None
    _ep = [0,0]      #none or the location of the current en passant pawn
    _fifty = 0
